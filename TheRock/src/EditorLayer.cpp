...
namespace RockEngine {
	...
	void EditorLayer::OnAttach()
	{
		...
		geoRenderPassSpec.TargetFramebuffer = RockEngine::Framebuffer::Create(geoFramebufferSpec);
		...
		compRenderPassSpec.TargetFramebuffer = RockEngine::Framebuffer::Create(compFramebufferSpec);
